...
```
目标:为{argument name="product name" default="维生素 C 精华液"}创建高端电影化奢华护肤广告,聚焦光彩肌肤、金橙色精华液和新鲜橙子。

画布:垂直 3:4 图像,分为恰好 2 个水平面板,由细白分隔线分隔。温暖黄金时段阳光、浅景深、光泽反射表面、高级美容广告摄影。

主体细节:一位美丽年轻女性,配{argument name="hair color" default="长深棕色头发"}、自然焕发肌肤、柔和优雅面部特征、浓眉、极简暖妆、小钉耳环、精致项链以及温和自信微笑。她穿着简单白色吊带背心。她的表情平静、清新且自然,看向相机。
