...
```
服装：女性休闲夏季服装，特色是{argument name="top" default="黄白格子吊带上衣"}，采用轻质棉布面料，细吊带、柔软聚拢的胸部、轻结构帝腰到腰部过渡和喇叭裙摆娃娃下摆，具有高级面料质感、逼真服装构造、干净缝线、自然接缝张力、可信的面料重量、微妙褶皱、逼真垂坠、精致边缘处理、可见接缝、真实褶痕、精心制作的服装细节、高质量材质感和详细服装写实性；搭配{argument name="bottoms" default="浅蓝色水洗牛仔短裤"}，带可见接缝、自然褪色、干净整理、可信的牛仔布重量、微妙褶皱和逼真服装构造；配以{argument name="shoes" default="象牙到浅米色厚底运动凉鞋"}，带黑色装饰、宽面料或帆布式肩带、圆形金属五金细节和黑色橡胶鞋底；添加随机混合的精致女性极简配饰，柔和金色调或珍珠色调，自然匹配服装；不像服装道具、不显廉价。
```
