...
```
创建一张高端极简主义产品摄影,展示Nothing 透明无线耳机在透明方形充电盒中对角平衡于粗糙堆叠石头基座顶部。场景为垂直 3:4,居中构图,透明圆角方形盒在岩石上方以 35 度倾斜漂浮或轻轻静置。盒内有恰好 2 个可见耳机,一个靠近右上方,一个靠近左下方,配光泽黑色和金属内部组件、透明耳柄和白色半透明耳塞;盒有可见铰链、接缝、圆角以及内表面上一个小微妙文字标记写着"NOTHING"。基座由恰好 2 块大型粗糙石块组成:一块较高的浅灰上岩石带锐利质感,下方一块较深较宽的下岩石,两者均从左上方戏剧性照明,使右侧落入深阴影。使用柔和烟灰影棚背景,配温和晕影、颗粒大气雾霾,无可见地平线。照明应为电影化和定向性,强调时尚透明电子产品与原始石头质感之间的对比,配塑料边缘清晰高光、柔和阴影、逼真反射、浅景深以及受 Nothing 启发的高级工业设计美学。无额外物品、无手、无包装、无大型排版、无水印。
```
