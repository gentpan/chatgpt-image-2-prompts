...
将[品牌名称]转化为未来主义高级能量饮料品牌,使用其现有标志、颜色、排版、形状、比例和视觉个性作为核心创意 DNA。
...
使用高端商业产品摄影、受控反射、戏剧性但逼真照明、柔和阴影和干净未来主义影棚环境。使每个设计决策针对[品牌名称]
```
...
Use high-end commercial product photography, controlled reflections, dramatic but realistic lighting, soft shadows, and a clean futuristic studio environment. Make every design decision specific to [BRAND NAME]
```
