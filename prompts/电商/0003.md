...
```
创作一张电影级高端收藏手办产品照，展示{argument name="character name" default="龙猫"}的悬浮机器人版本，以光泽黑色蒸汽朋克/机甲猫-森林精灵玩具的形态重新演绎，具有圆形身体、灰白色肚皮、可见的金属板缝合线、划痕、铆钉和磨损边缘。手办有精确 2 颗发光的温暖琥珀色圆形 LED 眼睛、精确 2 个高耸的黑色锥形耳朵/角、一个露齿的宽笑（奶油色矩形牙齿）、细黑胡须、精确 2 条伸展的分段机械手臂，以及每只手 5 根尖刺爪的刺爪手。肚皮上有精确 7 个温暖发光的新月形 LED 镂空，排列成经典龙猫胸前标记图案。机器人悬浮于圆形黑色展示底座上的精致微缩景观透视模型之上：微型森林山丘、蜿蜒蓝色河流、小房屋、薄雾云彩和烟雾效果。身体下方有精确 2 束明亮橙色喷射火焰，下方有蒸汽云，手办背后可见精确 3 根透明弯曲亚克力支撑杆。将场景设置在戏剧性的{argument name="background setting" default="日落山谷，河流和远处湖泊"}背景前，配以橙粉色云彩、接近地平线的低悬太阳和温暖的反射光。使用浅景深、逼真的影棚微距摄影、高级树脂手办工艺、电影级照明、柔和散景、高度细致的纹理，方形竖版构图。无文字、无水印。
```
