...
```
目标:为高端计算机显卡和散热风扇创建高级产品品牌拼贴画,使用{argument name="brand logo" default="极简主义角度 S 形字母组合"}作为唯一可见标志标记。
...
色板:{argument name="primary hardware color" default="哑光黑和石墨"}、{argument name="accent color" default="深蓝灰"}、{argument name="background color" default="暖浅灰和深木炭"}。
